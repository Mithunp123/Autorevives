  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-surface mesh-bg p-6">
      <div className="text-center max-w-md">
        <div className="w-24 h-24 mx-auto mb-6 bg-gradient-to-br from-primary-100 to-primary-50 rounded-3xl flex items-center justify-center shadow-glow">
          <i className="fas fa-car text-4xl text-accent"></i>
        </div>
        <h1 className="text-7xl font-extrabold font-display text-gradient mb-3">404</h1>
